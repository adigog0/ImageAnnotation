...
const UserCommentPill = ({ metadata, isSelected, comments = [], onReply }: UserCommentPillProps) => {
  //state
    ...
    >
      ...
      {isSelected && (
        ...
        >
          ...
          <CommentInputBox handleInputValue={onReply} input_placeholder="Reply" initial_value="" />
        </div>
      )}
...
export default memo(UserCommentPill);
